...
void TestLug::addAttendantModel()
{
    ...
    personModel->addPerson("1222234233", "a22lirezds2222a32", "hosgdfd222dsr", "a2lw22i2ael222i@lkfdj.com");
    personModel->submitAll();
    ...
    int personId = personModel->getPersonId("1222234233");
    int dueDayId = dueDayModel->GetDateId("2017-12-22");
    QCOMPARE(true, attendantModel->addAttendant(personId, dueDayId));
    attendantModel->revertAll();
}

void TestLug::findAttendantModel()
{
    // adding persons first
    personModel->addPerson("56565656", "a212li2a32", "rrghjere", "a2lw2rdtggl222i@lkfdj.com");
    personModel->submitAll();
    ...
    int personId = personModel->getPersonId("56565656");
    int dueDayId = dueDayModel->GetDateId("2017-04-02");
    QCOMPARE(true, attendantModel->addAttendant(personId, dueDayId));
...
{
    // adding persons first
    personModel->addPerson("56511156", "a111li2a32", "rrghj11ere", "a2l1111dtggl222i@lkfdj.com");
    personModel->submitAll();
    ...
    //adding them in attendant
    int personId = personModel->getPersonId("56511156");
    int dueDayId = dueDayModel->GetDateId("2010-11-01");
    attendantModel->addAttendant(personId, dueDayId);
    attendantModel->submitAll();
